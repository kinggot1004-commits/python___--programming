...
d.update(d2) # upsert(없으면 insert, 있으면 update(value만 바꿈))
print(d)
print(d.pop("city"))
print(d)
d.clear()
...
a,*b,c = d
print(a,b,c)
print({**d}) #언패킹해서 다른 딕셔너리에 담음
d2 = {"eng":90,"sci":95}
print({**d, **d2}) # update와 동일하게 출력
...
print(dict(zip([i for i in range(1,11)],[i**2 for i in range(1,11)])))
...
result = {k for k,v in scores.items() if v >= 90}
print(result)
# =========================================================
#  🔥 실습 문제
# =========================================================
