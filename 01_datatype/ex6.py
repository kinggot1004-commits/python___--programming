...
start = time.time()
for i in range(10):
    my_list.append('1')                                   # 동일 리스트 객체에 append
...
s = "1311"
print(s[0]+"학년 "+s[1]+ "반 "+str(int(s[2])*10+(int(s[3])))+"번")                  # ✅ "1학년 3반 1번" 출력

# # 2️⃣ 학번을 슬라이싱만을 이용해서 학년, 반, 번호로 잘라내기
print(s[0:1]+"학년 "+s[1:2]+ "반 "+str(int(s[2:4]))+"번")                  # ✅ "1학년 3반 1번" 출력