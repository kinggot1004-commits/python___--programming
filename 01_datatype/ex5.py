...
print(s.find("python"))             # 인덱스 반환, 없으면 -1
print(s.index("python"))            # 인덱스 반환, 없으면 오류
...
print(s.replace("python","game"))     # 전체 치환
print(s.replace("python","game",1))  # 1개만 치환

# # 판별 문자열 메소드 (isXXX())
print("123".isdigit())              # 숫자이면 True
print("123".isnumeric())             # 알파벳이면 True
print("abc123".isalnum())           # 알파벳 + 숫자이면 True
print(" \t \n".isspace())          # 전부 공백문자이면 True
